...
const messages = {
  ...
  INVALID_NEW_PASSWORD:
    "New password is the same with your old one. Please try to change your password again.",
  ...
  EMIL_IS_NOT_EXIST:
    "Your email Address is not exist or not authorized recipients.",
  ...
  EMAIL_RESET_LINK_SENT_SUCCESSFULLY:
    "Sent the new password to your email. Please check your email.",
  VERIFIED_TOKEN_SUCCESSFULLY:
    "Verified the token to reset your password. Please type your new and confirm password.",
  ...
  SUBACCOUNT_HAS_BEEN_UPDATED_STATUS:
    'Your account status has been updated with "ACTIVE" ',
  NOT_USE_THIS_DISCOUNT_CODE:
    "You cant use this discount code because not charge",
